...
function init() {
    ...
    var endOfDay = new Date(now.getFullYear(), now.getMonth(), now.getDate(), 24, 59, 59, 999)

    // Calculate the remaining time from now until midnight tonight.
    var timeDiff = endOfDay - now;

    setTimeout(countDown, timeDiff);
}
...
function countDown() {
    ...
    document.querySelector('.cake').innerHTML = `<div class="velas">
    <div class="fuego"></div>
    <div class="fuego"></div>
    <div class="fuego"></div>
    <div class="fuego"></div>
...
<svg id="cake" version="1.1" x="0px" y="0px" width="200px" height="500px" viewBox="0 0 200 500" enable-background="new 0 0 200 500" xml:space="preserve">
    <path fill="#FFA500" d="M173.667-13.94c-49.298,0-102.782,0-147.334,0c-3.999,0-4-16.002,0-16.002
    ...
    <path fill="rgba(255, 215, 0, 1)" d="M100-178.521c1.858,0,3.364,1.506,3.364,3.363c0,0,0,33.17,0,44.227
    ...
    <path fill="rgba(152, 251, 152, 1)" d="M173.667-15.929c-46.512,0-105.486,0-147.334,0c-3.999,0-4-16.002,0-16.002
    ...
    <path fill="rgba(230, 230, 250, 1)" d="M101.368-73.685c0,12.164,0,15.18,0,28.519c0,22.702,0-13.661,0,8.304c0,14.48,0,18.233,0,30.512
    ...
    <path fill="rgba(255, 209, 220, 1)" d="M173.667,21.571c-33.174,0-111.467,0-147.334,0c-4,0-4-16.002,0-16.002c39.836,0,105.982,0,147.334,0
    ...
    <rect x="10" y="475.571" fill="rgb(255, 248, 220)" width="180" height="4" />
</svg>
<div class="text">
<h1>HAPPY BIRTHDAY!</h1>
<h3>Quốc Dũng (Đỗ Hùng)</h3>
<h3>(21 Years old)</h3>
</div>`
...
function updateCountdown() {
    //Get the div tag containing the countdown.
    var countdownDiv = document.getElementsByClassName("loading-init__header")[0];

    var now = new Date();

    //Calculate the remaining time until the end of the day.
    var endOfDay = new Date(now.getFullYear(), now.getMonth(), now.getDate(), 24, 59, 59, 999) - now;

    // Convert the remaining time into hours, minutes, seconds.
    var hoursLeft = Math.floor(endOfDay / (1000 * 60 * 60));
    var minutesLeft = Math.floor((endOfDay % (1000 * 60 * 60)) / (1000 * 60));
    var secondsLeft = Math.floor((endOfDay % (1000 * 60)) / 1000);


    countdownDiv.innerHTML = hoursLeft + " : " + minutesLeft + " : " + secondsLeft;

    // If the remaining time is 0, stop counting down.
    if (endOfDay <= 0) {
        clearInterval(countdownInterval);
        countdownDiv.innerHTML = "Start Birthday!";
    }
}
...
if (IS_HEADER) {
    ...
    setLoadingStatus('Fireworks are coming soon...');
    setTimeout(() => {
